...
public class NotificationTemplateAsserts {
    ...
    public static void assertNotificationTemplateUpdatableFieldsEquals(NotificationTemplate expected, NotificationTemplate actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getPushTitle()).as("check pushTitle").isEqualTo(expected.getPushTitle()))
            .satisfies(a -> assertThat(a.getPushBody()).as("check pushBody").isEqualTo(expected.getPushBody()))
